...
alias matlab11='/usr/local/MATLAB/R2011a/bin/matlab'
...
export PS1='\[\e[7m\]$(/home/jack/bin/variprompt.sh $COLUMNS 30)\[\e[32m\]$(__git_ps1)\[\e[39m\]\[\e[27m\] '
...
alias padrino='~/.rbenv/versions/1.9.2-p290/lib/ruby/gems/1.9.1/bin/padrino'

alias trash='trash-put'

function makecss()
{
  for less in assets/stylesheets/*.less ; do
    cssname=`basename "$less" .less`
    lessc "$less" > "public/stylesheets/$cssname.css"
    echo LESS '=>' CSS "$cssname"
  done
}
